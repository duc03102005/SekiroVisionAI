...
## Windows package evidence, 2026-09-11

Commit `6f75aaefba886fdc54ed7dcce7d01ebd26f78866` was built on Windows Server 2022 with the Release x64 toolchain. [CI run 34545500847](https://github.com/duc03102005/SekiroVisionAI/actions/runs/34545500847) passed all 10 native tests in 5.98 seconds, including actual input receiver/watchdog testing (2.48 seconds) and native MP4 replay (2.67 seconds). The application and packaged application both exited their startup smoke tests successfully. The packaged app and ReplayHarness loaded with a system-only PATH and app-local runtime DLLs.

The [internal Windows package](https://github.com/duc03102005/SekiroVisionAI/actions/runs/34545500847/artifacts/10178918800) is 17,174,204 bytes; its ZIP SHA-256 is `323cc31bcaa44be070de57b8e6eefe2718ab6f00f0da2429ee66ef8ea1b47a50`. It contains `SekiroVisionAI.exe`, `ReplayHarness.exe`, runtime dependencies and the Vietnamese guide. **It has no production model and is not the requested functional Auto Dodge release.** The [native test evidence](https://github.com/duc03102005/SekiroVisionAI/actions/runs/34545500847/artifacts/10178917516) is preserved separately. These GitHub Actions artifacts have 30-day retention.
