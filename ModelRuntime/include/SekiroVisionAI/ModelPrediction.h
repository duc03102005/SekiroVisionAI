...
inline constexpr const char* movement_states[]{"IDLE", "WALK", "RUN", "TURN", "ATTACK_WINDUP",
    "ACTIVE_ATTACK", "RECOVERY", "COMBO_CONTINUATION", "FEINT", "UNKNOWN_STATE"};
...
struct ModelPrediction {
    ...
    bool state_supported{}, class_supported{}, observed_direction_supported{};
    ...
    int state{9}, attack_class{13}, observed_direction{4}, attack_direction{7};
